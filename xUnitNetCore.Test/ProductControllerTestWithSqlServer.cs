...
{
    public class ProductControllerTestWithSqlServer : ProductControllerTest
    {
        public ProductControllerTestWithSqlServer()
        {
            ...
            SetContextOptions(new DbContextOptionsBuilder<AppDbContext>().UseSqlServer(sqlConnection).Options);
        ...
        public async Task Create_ModelValidProduct_ReturnRedirectToActionWithSaveProduct()
        {
            ...
            var newProduct = new Product() { Name = "Kalem 30", Price = 200, Stock = 200, Color= "Black"};
